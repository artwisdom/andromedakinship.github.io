...
const freshIds = new Set(apps.map(app => app.id));
if (previous.apps.some(app => !freshIds.has(app.id))) throw new Error('The App Store omitted saved apps. Review removals manually; the snapshot was not changed.');
